...
| [LLM API Smoke Tests](docs/guides/llm-api-smoke.md) | One-command provider checks, credential handling, result semantics, and troubleshooting |
| [Trajectory Visualization](docs/guides/trajectory-visualization.md) | Layered planner/controller/execution traces, live Viser use, and offline replay |
