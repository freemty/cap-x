...
def load_libero_task(
    ...
    vendor_python_root = os.path.join(vendor_root, "libero")
    if os.path.isdir(vendor_python_root) and vendor_python_root not in sys.path:
        sys.path.insert(0, vendor_python_root)
    try:
