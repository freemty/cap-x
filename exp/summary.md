...
| exp00b | Run GLM-5.2 through CaP-X on ten RoboTwin tasks and verify frontend ingestion | In Progress | Fixed 10-task subset; live run awaiting rotated GLM credential |
